        ...
        <div class="related_view newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><?=Html::img('@web/images/relate_view1.jpg')?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=Html::img('@web/images/relate_view2.jpg')?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=Html::img('@web/images/relate_view3.jpg')?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=Html::img('@web/images/relate_view4.jpg')?></a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><?=Html::img('@web/images/relate_view5.jpg')?></a></dt>
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <?php foreach(\backend\models\GoodsGallery::find()->where(['goods_id'=>$model->id])->all() as $k=>$gallery):?>
                        <?php if($k==0){?>
                    <a href="http://admin.yii2shop.com/.<?=$gallery->path?>" class="jqzoom" rel="gal1">
                        <?=Html::img('http://admin.yii2shop.com/'.$gallery->path)?>              <!-- 第一幅图片的中图 -->
                    </a>
                        <?php
                        }?>
                    <?php endforeach;?>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <?php foreach(\backend\models\GoodsGallery::find()->where(['goods_id'=>$model->id])->all() as $k=>$gallery):?>
                                <li <?=$k==0?"class='cur'":''?>>
                                    <a <?=$k==0?"class='zoomThumbActive'":''?> href="javascript:void(0);"
                                        rel="{gallery: 'gal1', smallimage: '<?='http://admin.yii2shop.com'.$gallery->path?>',largeimage: '<?='http://admin.yii2shop.com'.$gallery->path?>'}">
                                    <?=Html::img('http://admin.yii2shop.com/'.$gallery->path)?></a>
                                </li>
                            <?php endforeach;?>
<!--
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'http://www.yii2shop.com/images/preview_m1.jpg',largeimage: 'http://www.yii2shop.com/images/preview_l1.jpg'}">
                                    <?/*=Html::img('@web/images/preview_s1.jpg')*/?></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'http://www.yii2shop.com/images/preview_m2.jpg',largeimage: 'http://www.yii2shop.com/images/preview_l2.jpg'}">
                                    <?/*=Html::img('@web/images/preview_s2.jpg')*/?></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'http://www.yii2shop.com/images/preview_m3.jpg',largeimage: 'http://www.yii2shop.com/images/preview_l3.jpg'}">
                                    <?/*=Html::img('@web/images/preview_s3.jpg')*/?></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'http://www.yii2shop.com/images/preview_m4.jpg',largeimage: 'http://www.yii2shop.com/images/preview_l4.jpg'}">
                                    <?/*=Html::img('@web/images/preview_s4.jpg')*/?></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'http://www.yii2shop.com/images/preview_m5.jpg',largeimage: 'http://www.yii2shop.com/images/preview_l5.jpg'}">
                                    <?/*=Html::img('@web/images/preview_s5.jpg')*/?></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'http://www.yii2shop.com/images/preview_m6.jpg',largeimage: 'http://www.yii2shop.com/images/preview_l6.jpg'}">
                                    <?/*=Html::img('@web/images/preview_s6.jpg')*/?></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'http://www.yii2shop.com/images/preview_m7.jpg',largeimage: 'http://www.yii2shop.com/images/preview_l7.jpg'}">
                                    <?/*=Html::img('@web/images/preview_s7.jpg')*/?></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'http://www.yii2shop.com/images/preview_m8.jpg',largeimage: 'http://www.yii2shop.com/images/preview_l8.jpg'}">
                                    <?/*=Html::img('@web/images/preview_s8.jpg')*/?></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'http://www.yii2shop.com/images/preview_m9.jpg',largeimage: 'http://www.yii2shop.com/images/preview_l9.jpg'}">
                                    <?/*=Html::img('@web/images/preview_s9.jpg')*/?></a>
                            </li>-->
                        </ul>
                    </div>
        ...
        <div class="detail">
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            <li><span>商品名称：</span><?=$model->name?></li>
                            <li><span>商品编号：</span><?=$model->sn?></li>
                            <li><span>品牌：</span><?=$model->brand->name?></li>
                            <li><span>上架时间：</span><?=date('Y-m-d',$model->create_time)?></li>
                ...
                <div class="comment detail_div mt10">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><?=Html::img('@web/images/user1.gif')?></a></dt>
                                <dd><a href="">乖乖</a></dd>
                            </dl>
                        </div>
                        <div class="item">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><?=Html::img('@web/images/user2.jpg')?></a></dt>
                                <dd><a href="">小宝贝</a></dd>
                            </dl>
                        </div>
                        <div class="item">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><?=Html::img('@web/images/user3.jpg')?></a></dt>
                                <dd><a href="">天使</a></dd>
                            </dl>
                        </div>
                        <div class="item">
