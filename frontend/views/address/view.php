        ...
        <div class="goodslist mt10">
            <ul>
                <?php foreach($Lists as $List):?>
                    <li>
                        <dl>
                            <dt><a href="<?=\yii\helpers\Url::to(['address/goods','id'=>$List->id])?>"><?=Html::img('http://admin.yii2shop.com/'.$List->logo)?></a></dt>
                            <dd><a href=""><?=$List->name?></a></dt>
                            <dd><strong>￥<?=$List->shop_price?></strong></dt>
                            <dd><a href=""><em>已有<?=$List->stock?>人评价</em></a></dt>
                        </dl>
                    </li>
                <?php endforeach;?>
